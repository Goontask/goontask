...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="form-group">
        ...
        <div class="col-sm-6">
        <?php echo $form->textField($model,'start', array('class'=>'form-control form-control-inline input-medium default-date-picker')); ?>
	...
	<div class="form-group">
        ...
        <div class="col-sm-6">
        <?php echo $form->textField($model,'deadline', array('class'=>'form-control form-control-inline input-medium default-date-picker')); ?>
	...
	<div class="form-group">
        ...
        <div class="col-sm-6">
        <?php echo $form->textField($model,'private_or_public',array('class'=>'form-control', 'size'=>1,'maxlength'=>1)); ?>
	...
	<div class="form-group">
        ...
        <div class="col-sm-6">
        <?php echo $form->textField($model,'members',array('class'=>'form-control', 'size'=>60,'maxlength'=>400)); ?>
	...
	<div class="form-group">
        ...
        <div class="col-sm-6">
        <?php echo $form->textField($model,'files',array('class'=>'form-control', 'size'=>60,'maxlength'=>255)); ?>
